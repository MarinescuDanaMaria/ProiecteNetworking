...
export default function Profile() {
  const { userDetail, setUserDetail } = useContext(UserDetailContext); // inf despre utilizator
  ...
  const getBadgeInfo = (badgeName) => {
    switch (badgeName) {
      case "Începător în securitate":
        return {
          icon: "shield-checkmark",
          color: "#4CAF50",
          description: "Ai finalizat cursul introductiv de securitate!"
        };
      case "Securitate personală":
        return {
          icon: "ribbon",
          color: "#FF9800",
          description: "Ai învățat despre cum să te protejezi în online!"
        };
      case "Securitate informatică":
        return {
          icon: "lock-closed",
          color: "#2196F3",
          description: "Stăpânești tehnicile de apărare și prevenție!"
        };
      case "Securitate pe internet":
        return {
          icon: "trophy",
          color: "#9C27B0",
          description: "Expert în analiza cazurilor reale!"
        };
       case "Securitate mobilă":
      return {
        icon: "bulb",
        color: "#795548",
        description: "Ai finalizat cursul de securitate mobilă!"
      };
       case "Confidențialitate":
      return {
        icon: "lock-closed",
        color: "#607D8B",
        description: "Ai finalizat cursul de securitate mobilă!"
