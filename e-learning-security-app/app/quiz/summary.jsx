...
export default function QuizSummary() {
  ...
  const updateUserProgress = async () => {
    ...
    try {
      ...
      // elimin logica de adăugare a insignei la quiz
      // let newBadges = [...(userData.badges || [])];
      // const courseData = coursesData.find(c => c.docId === course.docId || c.title === course.title);
      // const achievementBadge = courseData?.achievementBadge;
      // if (course?.docId && achievementBadge && !userData.badges?.includes(achievementBadge)) {
      ...
      //     newBadges.push(achievementBadge);
      //   }
      // }
      ...
      const updatedData = {
        ...
        rank: newRank,
        completedQuizzes,
        // badges: newBadges // eliminat, nu actualizăm insignele aici
      };
      ...
      alert("A apărut o eroare la actualizarea progresului. Verifică dacă ești autentificat.");
    } finally {
      setLoading(false);
    }
  };
